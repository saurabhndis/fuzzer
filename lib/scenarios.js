...
const { PCAP_CATEGORY, getPcapScenario, listPcapScenarios, getPcapScenariosByCategory } = require('./pcap-scenarios');
...
// PCAP = PCAP-based tests (opt-in, loaded from pcap-tests/ directory)
const CATEGORY_DEFAULT_DISABLED = new Set(['Z', 'SRV', 'PCAP', 'RA', 'RB', 'RC', 'RD', 'RE', 'RF', 'RG']);

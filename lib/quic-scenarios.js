...
const { listHttp2ClientScenarios } = require('./http2-scenarios');
...
/**
 * Generate QUIC-adapted versions of TLS and HTTP/2 client scenarios.
...
function generateAdaptedQuicScenarios() {
  ...
  const h2ClientScenarios = listHttp2ClientScenarios();

  // Combine both TLS and H2 client scenarios for adaptation
  const allScenarios = [...tlsClientScenarios, ...h2ClientScenarios];

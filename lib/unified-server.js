...
const { ContentType, HandshakeType, AlertLevel, AlertDescription, ExtensionType, CipherSuiteName } = require('./constants');
    ...
    return new Promise((resolve) => {
      ...
      const handleStream = (stream) => {
        ...
        try {
          ...
          const handlerResult = scenario.serverHandler(stream, stream.session, log);
          const settle = () => setTimeout(finalize, 25);

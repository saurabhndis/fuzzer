...
contextBridge.exposeInMainWorld('fuzzer', {
  ...
  listPcapStreams: (path) => ipcRenderer.invoke('list-pcap-streams', path),
  analyzePcap: (path, streamIndex) => ipcRenderer.invoke('analyze-pcap', path, streamIndex),
  ...
  savePcapTest: (scenario) => ipcRenderer.invoke('save-pcap-test', scenario),
